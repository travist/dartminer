...
class Block {
  ...
  Block.fromJSON(Map<String, dynamic> block) {
    ...
    tx = (block['tx'] as List<dynamic>).map((e) => e as String).toList();
  ...
  Work toWork() {
    ...
    return new Work.fromHeader(getHeader(), target, nonce: reverseBytesInWord(nonce), expires: expires);
  }
